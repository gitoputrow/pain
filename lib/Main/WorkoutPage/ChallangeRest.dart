...
class Challange_Rest extends StatefulWidget {

  String nextWorkout = "";
  String reps = "";
  Challange_Rest(this.nextWorkout,this.reps);

  @override
  _Challange_RestState createState() => _Challange_RestState();
}

class _Challange_RestState extends State<Challange_Rest> with SingleTickerProviderStateMixin {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "Next is ${widget.nextWorkout} ${widget.reps} x",
                      style: TextStyle(
